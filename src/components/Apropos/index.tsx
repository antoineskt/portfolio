...
import pngcoding from './pngcoding.png'
...
export default function Apropos() {
  return (
    <SectionApropos>
      ...
      <Div>
        <DivPropos>
          <Img src={pngcoding} alt="logocoding" />
          <H2>Coding</H2>
          <P>
            Depuis maintenant plus de 3 ans, je développe et crée des sites webs. J'adore coder en React, même si je
            suis prêt à me plonger dans n'importe quel langage sans problème.
          </P>
        </DivPropos>

        <DivPropos>
          <svg role="img" width="100px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <title />
          ...
          <P>
            Je code également des applications mobile en React native et des application webs et thème/site sur Shopify.
          </P>
        </DivPropos>
      </Div>
    </SectionApropos>
